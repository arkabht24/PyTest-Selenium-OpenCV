...
class Login_page:
    ...
    def navigate_to_login_page(self):
        ...
        time.sleep(5)
        self.interact.take_screenshot(os.path.join((self.dir_path),"Navigated to application.png"))
    ...
    def input_username(self,username):
        ...
        time.sleep(5)
        self.interact.take_screenshot(os.path.join((self.dir_path),"Username inserted.png"))
    ...
    def input_password(self,password):
        ...
        time.sleep(5)
        self.interact.take_screenshot(os.path.join((self.dir_path),"Password inserted.png"))

    def click_on_login_button(self):
        self.driver.find_element(*self.locators["LOGIN_BUTTON"]).click()
        time.sleep(5)
        self.interact.take_screenshot(os.path.join((self.dir_path),"Clicked on Login Button and logged in.png"))
